...
public class PtrFrameLayout extends ViewGroup {
    ...
    public PtrFrameLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mPagingTouchSlop = conf.getScaledTouchSlop() * 2;//conf.getScaledTouchSlop() 系统默认手指滑动多少像素点以后才算是scroll
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent e) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                Log.d("PtrFrameLayout", "offsetX:" + offsetX + "     offsetY:" + offsetY);
                Log.d("PtrFrameLayout", "!mPreventForHorizontal" + !mPreventForHorizontal);
...
//                if (mDisableWhenHorizontalMove && !mPreventForHorizontal && (Math.abs(offsetX) > mPagingTouchSlop && Math.abs(offsetX) > Math.abs(offsetY))) {
                ...
                if (mPreventForHorizontal) {
                    Log.d("PtrFrameLayout", "dispatchTouchEventSupper");
                ...
                Log.d("PtrFrameLayout", "moveDown:" + moveDown + "  canMoveDown:" + canMoveDown);
                Log.d("PtrFrameLayout","*******************************");
                if (DEBUG) {
                ...
                if (canMoveUp) {
                    if (onTouchScrollY != null) {
                        onTouchScrollY.onScrollY(e.getY());
                    }
                    moveHeaderPos(offsetY);
                    return true;
                }
    ...
    private OnTouchScrollY onTouchScrollY;

    public void setOnTouchScrollY(OnTouchScrollY onTouchScrollY) {
        this.onTouchScrollY = onTouchScrollY;
    }

    public interface OnTouchScrollY {
        void onScrollY(float y);
