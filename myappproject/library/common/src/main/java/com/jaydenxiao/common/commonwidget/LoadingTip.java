    ...
    */
    ...
    private void initView(Context context) {
      //  View.inflate(context, R.layout.dialog_loading_tip, this);
        ...
        mContext = context;
        View view = LayoutInflater.from(mContext).inflate(R.layout.dialog_loading_tip, null);
        img_tip_logo = (ImageView)view.findViewById(R.id.img_tip_logo);
        progress = (ProgressBar)view.findViewById(R.id.progress);
        tv_tips = (TextView)view.findViewById(R.id.tv_tips);
        bt_operate = (Button)view.findViewById(R.id.bt_operate);
        //重新尝试
