...
public class ClassicRefreshHeaderView extends RelativeLayout implements RefreshTrigger {
    ...
    public void onMove(boolean isComplete, boolean automatic, int moved) {
        if (!isComplete) {
            ...
            if (moved <= mHeight) {
                ...
                tvRefresh.setText(mContext.getResources().getString(R.string.drop_down_refresh)); //SWIPE TO REFRESH"
            } else {
                tvRefresh.setText(mContext.getResources().getString(R.string.looseninga_and_refreshing));//RELEASE TO REFRESH
                if (!rotated) {
                    ivArrow.clearAnimation();
    ...
    public void onRefresh() {
        ...
        tvRefresh.setText(mContext.getResources().getString(R.string.refresh_ing)); //REFRESHING
    }
    ...
    public void onComplete() {
        ...
        ivArrow.setVisibility(GONE);
        progressBar.setVisibility(GONE);
        tvRefresh.setText(mContext.getResources().getString(R.string.refresh_complete)); //COMPLETE
    }
