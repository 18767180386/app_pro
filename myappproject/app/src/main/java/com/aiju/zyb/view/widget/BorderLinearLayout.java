...
public class BorderLinearLayout extends LinearLayout {
    private final static int DEFAULT_BORDER_SIZE = SettingUtil.dip2px(1);
    ...
    public BorderLinearLayout(Context context, AttributeSet attrs) {
        ...
        mBorderColor = a.getColor(R.styleable.BorderLinearLayout_border_colors, Color.RED);
        mBoderLeftSize = a.getDimensionPixelSize(R.styleable.BorderLinearLayout_border_left_size, DEFAULT_BORDER_SIZE);
        mBoderTopSize = a.getDimensionPixelSize(R.styleable.BorderLinearLayout_border_top_size, DEFAULT_BORDER_SIZE);
        mBoderRightSize = a.getDimensionPixelSize(R.styleable.BorderLinearLayout_border_right_size, DEFAULT_BORDER_SIZE);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (mBoderRightSize > 0) {
            tempRect.setEmpty();
            tempRect.set(vw - mBoderRightSize, 0, 0, vh);
            canvas.drawRect(tempRect, borderPaint);
        }
